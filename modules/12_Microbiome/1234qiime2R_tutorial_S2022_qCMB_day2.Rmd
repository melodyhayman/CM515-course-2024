---
title: "my_hw_qiime2R_tutorial_S2022_qCMB_day2"
author: "Heather Deel"
date: '2022-04-22'
...
wild type/ pd and susptible/ pd cluster together and wild type/ healthy and susptible/ healthy cluster together
...
you see distinct clustering, weighter unifrac isnt as clearly clustered
...
I could not run this chunk of code because phyloseq would not load correctly, due to this I could not run many sections of this tutorial
...
collinsella, butyricimonas, bacteroides, parabacteroides, cloacibacterium, enterococcus, turicibacter
...
added the questions from canvas here:
Day 1 (2 pts each):

1.  Compare and contrast Metagenomics vs amplicon sequencing, and list a benefit and drawback of each one.
metagemonics gives an overall view of microbial communites with less focus on specific DNA sequences while amplicon sequencing focuses on targeted analysis of taxonomic groups and genes. Both are used to study microbial communities. A benefit of metagenomics is it does not rely on knowing the microbial composition. A drawback is this creates a lot of data and can be hard to work with. A benefit of amplicon seqquencing is it is cost-effective. A drawback is it can miss rare taxa or genes not amplified with selected primers.
...
sample information, study desing, barcode information
this is important for proper identification, reproduciblity, quality control, data sharing, and proper interpretation
...
it is a way to compare diveristy of species across different samples by randomly subsampling reads from each sample to standardize sample sizes. This allows for more accurate comparisions of richness and diveristy. Some drawbacks are loss of information, sensitivity to sequencing depth, and statistical uncertainty

7.  What does beta diversity show that alpha diversity doesn't?
species turnover, community heterogeneity, biogeographic patterns, community assembly processes, and conservation implications

8.  What is ANCOM-BC used for and why did we use it in this class? 
identifying differentially abundant taxa, correcting for biases, handling sero-inflated data, and controlling false discovery rate

9.  Which taxa are differentially abundant between the genotype and donor status groups?
I was not able to do this due to a problem loading a package
